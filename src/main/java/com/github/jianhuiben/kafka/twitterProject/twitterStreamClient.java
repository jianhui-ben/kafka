...
public class twitterStreamClient {
    ...
    private static final Logger logger = LoggerFactory.getLogger(twitterStreamClient.class);
    final static String BEARER_TOKEN = "AAAAAAAAAAAAAAAAAAAAAIH9bgEAAAAAnTehTyr5Ej7vdAvHoZXXTY1gatw%3D9aRSus1xDXIJejHmoNKbcaPox5LIPmC1NfltZHiJ8fRtyjAGDI";

    public static BufferedReader getStreamTweets(Map<String, String> rules) throws IOException, URISyntaxException {
        // String bearerToken = System.getenv("BEARER_TOKEN");
        String bearerToken = BEARER_TOKEN;
        if (null != bearerToken) {
            setupRules(bearerToken, rules);
            logger.info("Successfully created rules!");
     ...
     * */
    private static BufferedReader connectStream(String bearerToken) throws IOException, URISyntaxException {
